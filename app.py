...
7. Base all questions strictly on the provided material."""
    ...
    try:
        ...
        if "choices" not in res_json:
            raise ValueError(res_json.get("error", {}).get("message", "API error"))
        ...
        return _json.dumps({{"error": f"AI returned invalid JSON. Please try again."}}), 500, {{"Content-Type": "application/json"}}
    except Exception as e:
