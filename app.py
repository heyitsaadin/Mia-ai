...
def _do_google_search(query, user_msg=None):
    """Run Google search and return formatted reply. Never hallucinates — returns None if no results."""
        ...
        try:
            sum_resp = requests.post(
                ...
                json={
                    ...
                    "messages": [
                        {"role": "system", "content": "Answer using ONLY the search results below. Be concise (2-3 sentences). Don't say 'based on search results' or 'according to'."},
