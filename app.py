...
- If a user seems stuck, confused, struggling with a topic, or explicitly asks for a video tutorial or wants to learn something visually → include [YOUTUBE:search query here] at the END of your reply.
- The search query should be specific and helpful, e.g. [YOUTUBE:python for loops beginner tutorial] or [YOUTUBE:how to center a div CSS]
- Only include ONE [YOUTUBE:...] tag per reply. Do not use it for every message — only when a video would genuinely help.
- You can still give a text reply alongside the YouTube tag.
...
YOUTUBE VIDEO CARD RULES:
- If a user seems stuck, confused, struggling with a topic, or explicitly asks for a video tutorial or wants to learn something visually → include [YOUTUBE:search query here] at the END of your reply.
- The search query should be specific, e.g. [YOUTUBE:python for loops beginner tutorial] or [YOUTUBE:how to center a div CSS]
- Only ONE [YOUTUBE:...] tag per reply. Only use it when a video would genuinely help — not for every message."""
    clean_msgs, last_img_prompt, last_img_analysis = _build_clean_history(history)
