...
def generate_quiz():
    ...
    # ── 5. Call Gemini Flash (higher free-tier limits than Groq) ──
    GEMINI_KEY = os.environ["GEMINI_API_KEY"]
    gemini_url = f"https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key={GEMINI_KEY}"

    system_prompt = f"""You are an expert academic exam question writer.
Return exactly {count} multiple-choice questions as a raw JSON array.

DIFFICULTY: {diff_note}

RULES:
1. Return ONLY a valid JSON array. No preamble, no markdown fences, no explanation.
2. Each element: {{"question":"...","options":["...","...","...","..."],"answer":"exact option string","explanation":"2-3 sentences"}}
3. Base questions strictly on the provided material.
4. Vary question types: recall, application, comparison, conceptual, why/how.
5. Options must be specific and plausible. No "None of the above".
6. Never repeat questions. Return exactly {count} questions."""
